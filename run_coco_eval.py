...
parser.add_argument('--gt_ann_file',   default='/data2/gyn/PycharmProjects/AAAI2021ATTMPT/detectron2/tools/datasets/coco/annotations/instances_val2014.json', type=str)
