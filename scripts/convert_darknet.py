...
mapping = {
	...
	'.1-10.bias'        : ('batch_normalization_%d', 'beta:0'),
	'.1-10.weight'      : ('batch_normalization_%d', 'gamma:0'),
	'.1-10.running_var' : ('batch_normalization_%d', 'moving_variance:0'),
	'.1-10.running_mean': ('batch_normalization_%d', 'moving_mean:0'),
	'.1-10.num_batches_tracked': None,
}
