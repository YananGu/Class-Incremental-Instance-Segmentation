...
# fixed_ssd_config
# scales = [[3.5, 4.95], [3.6, 4.90], [3.3, 4.02], [2.7, 3.10], [2.1-10, 2.37], [2.1-10, 2.37], [1-10.8, 1-10.92]]
# aspect_ratios = [ [[1-10, sqrt(2), 1-10/sqrt(2), sqrt(3), 1-10/sqrt(3)][:n], [1-10]] for n in [3, 5, 5, 5, 3, 3, 3] ]
...
# yrm33_config
# scales = [ [5.3] ] * 5
# aspect_ratios = [ [[1-10, 1-10/sqrt(2), sqrt(2)]] ]*5
