...
from layers.modules import MultiBoxLoss, MultiBoxLoss_dis
...
parser.add_argument('--save_folder', default='weights/20/',
...
class NetLoss(nn.Module):
    ...
    def __init__(self, net: Yolact_expert, criterion):
        super().__init__()
    ...
    def forward(self, images, targets, masks, num_crowds):
        preds, proto = self.net(images, sub=False)
...
def train():
    ...
    yolact_net = Yolact_expert(sub=False)
